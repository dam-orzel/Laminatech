                ...
                <div class="type-header-content">
                    <div class="row">
                        <div class="col-xs-12 col-lg-5 type-header-image">
                            <h2 class="d-block d-lg-none">Zaślepki</h2>
                            <img src="../images/wymiary/zaslepka-render.png" alt="" >
                        </div>
                ...
                <div class="row">
                    <div class="col-12 col-lg-6 content">
                            <div class="description">
                                <div class="bez-odplywu">
                                <h2>Zaślepki bez otworu odpływowego</h2>
                                <img src="../images/wymiary/zaslepka-bez.png" alt="">
                                <div class="row">
                                    <div class="col-6 column">
                                        <div class="zaslepki-table-title">
                                            <span>Wymiary zew. Odwodnienia</span>
                                        </div>
                                        <div class="zaslepki-table-content">
                                            <span>100mm x 40mm</span>
                                        </div>
                                        <div class="zaslepki-table-content">
                                    ...
                                    <div class="col-6 column">
                                        ...
                                        <div class="zaslepki-table-content">
                                            <span>ZASU 100/40</span>
                                        </div>
                                        <div class="zaslepki-table-content">
                                            <span>ZASU 100/50</span>
                                        </div>
                                        <div class="zaslepki-table-content">
                                            <span>ZASU 100/40</span>
                                        </div>
                    ...
                    <div class="col-12 col-lg-6 content">
                        <div class="description">
                            <div class="bez-odplywu">
                            <h2>Zaślepki z otworem odpływowym</h2>
                            <img src="../images/wymiary/zaslepka-bez.png" alt="">
                            <div class="row">
                                <div class="col-6 column">
                                    <div class="zaslepki-table-title">
