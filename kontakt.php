...
<?php include('assets/components/menu.php'); ?>
        ...
        <div class="container">
            <div class="row contact-banner">
                <div class="col-xs-12 col-md-12 col-lg-3">
                    <img src="images/logo.svg" alt="" class="google-maps-logo img-fluid">
                </div>
                ...
                <div class="col-xs-12 col-md-4 col-lg-3">
                    <ul>
                        <li>Regon: 240651869</li>
                        <li>NIP: 646-27-77-364</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <section class="contact-form">
        <div class="container">
            <h3>Napisz do nas szybką wiadomość</h3>
            <form class="contact-form-container">
                <div class="form-group">
                    <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Imię">
                </div>
                <div class="form-group">
                    <input type="email" class="form-control" id="formGroupExampleInput2" placeholder="Adres e-mail">
                </div>
                <div class="form-group">
